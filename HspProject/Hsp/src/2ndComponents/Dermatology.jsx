...
const doctors = [
  {
    ...
    fee: '₹1500',
    image: 'https://www.indicure.com/assets/img/best-surgeons/Dermitologist/Dr-S-K-Bose.webp'
  },
  {
    name: ' Dr. Rachna Jagia',
    specialization: 'Dermatologists',
    experience: '35 years',
    location: 'Pusa Road, Delhi',
    fee: '₹2000',
    image: 'https://www.indicure.com/assets/img/best-surgeons/Dermitologist/Dr-Rachna-Jagia.webp'
  },
  {
    ...
    fee: '₹1800',
    image: 'https://www.indicure.com/assets/img/best-surgeons/Dermitologist/Dr-Monica-Bambroo.webp'
  },
  {
    ...
    fee: '₹1700',
    image: 'https://www.indicure.com/assets/img/best-surgeons/Dermitologist/Dr-Pooja-Aggarwal.webp'
  },
  {
    ...
    fee: '₹1600',
    image: 'https://www.indicure.com/assets/img/best-surgeons/Dermitologist/Dr-Col-Rajagopal-A.webp'
  },
...
const FAQSection = () => (
  <div className="bg-white p-4 rounded-lg shadow-md my-8">
    ...
    <div className="mb-4">
      <h3 className="text-xl font-semibold">What types of conditions do Dermatologists treat?</h3>
      <p>Dermatologists treat conditions such as fractures, joint dislocations, arthritis, ligament injuries, and more.</p>
    </div>
    <div className="mb-4">
      <h3 className="text-xl font-semibold">When should I see an Dermatologists?</h3>
      <p>You should see an Dermatologists if you experience severe pain in your bones or joints, have sustained an injury, or have chronic Dermatologists conditions.</p>
    </div>
    {/* Add more FAQs here */}
  </div>
);
  ...
  <div className="bg-gradient-to-r from-blue-100 to-blue-300 min-h-screen p-4">
   <Navbar/>
    <header className="text-center my-6">
      <h1 className="text-4xl font-bold text-blue-900">Best Dermatologists in Delhi</h1>
    </header>
