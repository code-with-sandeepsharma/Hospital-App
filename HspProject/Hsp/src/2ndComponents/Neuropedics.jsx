...
const FAQSection = () => (
  <div className="bg-white p-4 rounded-lg shadow-md my-8">
    ...
    <div className="mb-4">
      <h3 className="text-xl font-semibold">What types of conditions do orthopedicians treat?</h3>
      <p>Orthopedicians treat conditions such as fractures, joint dislocations, arthritis, ligament injuries, and more.</p>
    </div>
    <div className="mb-4">
      <h3 className="text-xl font-semibold">When should I see an orthopedician?</h3>
      <p>You should see an orthopedician if you experience severe pain in your bones or joints, have sustained an injury, or have chronic orthopedic conditions.</p>
    </div>
    {/* Add more FAQs here */}
  </div>
);
...
const Neuropedics = () => (
  <div className="bg-gradient-to-r from-blue-100 to-blue-300 min-h-screen p-4">
    ...
    <header className="text-center my-6">
      <h1 className="text-4xl font-bold text-blue-900">Best Orthopedicians in Delhi</h1>
    </header>
