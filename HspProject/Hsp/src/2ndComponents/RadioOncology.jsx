...
const doctors = [
  {
    name: 'Dr. Amit Mittal',
    specialization: 'Radio_Oncologists',
    experience: '30 years',
...
const FAQSection = () => (
  <div className="bg-white p-4 rounded-lg shadow-md my-8">
    ...
    <div className="mb-4">
      <h3 className="text-xl font-semibold">What types of conditions do Radio_Oncologists treat?</h3>
      <p>Radio_Oncologists treat conditions such as fractures, joint dislocations, arthritis, ligament injuries, and more.</p>
    </div>
    <div className="mb-4">
      <h3 className="text-xl font-semibold">When should I see an Radio_Oncologists?</h3>
      <p>You should see an Radio_Oncologists if you experience severe pain in your bones or joints, have sustained an injury, or have chronic Radio_Oncology conditions.</p>
    </div>
    {/* Add more FAQs here */}
  </div>
);
...
const RadioOncology = () => (
  <div className="bg-gradient-to-r from-blue-100 to-blue-300 min-h-screen p-4">
    ...
    <header className="text-center my-6">
      <h1 className="text-4xl font-bold text-blue-900">Best Radio Oncologists in Delhi</h1>
    </header>
