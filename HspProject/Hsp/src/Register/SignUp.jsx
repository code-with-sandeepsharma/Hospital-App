...
export default function Signup() {
  ...
  const handleRegister = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:4001/api/v1/user/patient/register', formData);
    ...
    <section className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-100 mt-0">
      <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <form onSubmit={handleRegister} className="mt-8 space-y-6">
              <div className="space-y-5">
                ...
                <div>
                  <button
                    type="submit"
                    className="inline-flex w-full items-center justify-center rounded-md bg-black px-3.5 py-2.5 font-semibold leading-7 text-white hover:bg-black/80 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                  >
        ...
        <div className="h-full w-full">
          <img
            className="mx-auto h-half w-full pt-40 rounded-md object-cover"
